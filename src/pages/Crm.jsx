...
export default function Crm() {
  ...
  const currentUser = {
    ...
    role: user?.title || (user?.role === 'admin' ? 'Administrateur' : ((user?.firstName?.toLowerCase().includes('laurent') && user?.lastName?.toLowerCase().includes('guyon')) ? 'Président' : ((user?.firstName?.toLowerCase().includes('malick') && user?.lastName?.toLowerCase().includes('toure')) ? 'Responsable Développement' : 'Conseiller'))),
