...
export default function Crm() {
  ...
  const renderProjects = () => (
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 lg:gap-6">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap lg:flex-nowrap items-stretch sm:items-center gap-2.5 lg:gap-3 flex-1 min-w-0">
          <div className="relative w-full sm:w-56 lg:w-64 shrink-0">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" />
            <input
              type="text"
              placeholder="Rechercher..."
              className="w-full pl-9 pr-3 py-2 bg-white shadow-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-bold transition-all border shrink-0 ${
              filterMyProjects
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-xs font-extrabold transition-all whitespace-nowrap shrink-0 ${
                    isActive
        ...
        {/* Boutons d'Action & Vues */}
        <div className="flex flex-wrap sm:flex-nowrap gap-2 sm:gap-3 items-center justify-between lg:justify-end shrink-0 self-end lg:self-center">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {selectedProjects.length > 0 && isTransferAuthorized() && (
              <Button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-md flex items-center gap-1.5 text-xs sm:text-sm h-9 sm:h-10 px-3 sm:px-4"
              >
            ...
            {selectedProjects.length > 0 ? (
              <Button
                ...
                className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-md flex items-center gap-1.5 text-xs sm:text-sm h-9 sm:h-10 px-3 sm:px-4"
              >
              ...
              <Button
                ...
                variant="outline"
                className="border-slate-200 text-slate-700 hover:bg-slate-50 flex items-center gap-1.5 shadow-sm text-xs sm:text-sm h-9 sm:h-10 px-3 sm:px-4"
                disabled={filteredProjects.length === 0}
              >
                <FileDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600" />
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white shadow-md text-xs sm:text-sm h-9 sm:h-10 px-3 sm:px-4 flex items-center gap-1.5"
            >
  ...
  return (
    <div className="flex h-[calc(100vh-65px)] bg-gradient-to-br from-slate-50 via-white to-slate-100 overflow-hidden">
      ...
      <aside
        className={cn(
          "bg-slate-900 text-white flex flex-col justify-between shrink-0 transition-all duration-300 ease-in-out z-20 shadow-xl border-r border-slate-800",
          ...
          {sidebarOpen && (
            <div className="flex gap-2 mt-2">
              <button
                ...
                className="flex-1 p-1.5 hover:bg-slate-800 rounded-lg transition-colors"
                title="Paramètres"
              >
                <Settings className="w-4 h-4 mx-auto text-slate-400 hover:text-white" />
              </button>
              <button
                onClick={handleLogout}
                className="flex-1 p-1.5 hover:bg-red-500/20 rounded-lg transition-colors"
                title="Déconnexion"
              >
