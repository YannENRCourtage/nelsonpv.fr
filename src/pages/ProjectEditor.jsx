              ...
              <div className={`w-full h-full flex flex-col ${activeTab !== 'map' ? 'absolute inset-0 pointer-events-none opacity-0' : ''}`}>
                ...
                <div className="hidden lg:flex p-3 bg-gray-50 border-t flex-wrap gap-2">
                  ...
                  {[
                    ...
                    { key: 'zonesHumides', label: 'Zones Humides' },
                    { key: 'argilesRGA', label: 'Argiles (RGA)' },
                    { key: 'sitesPollues', label: 'Sites Pollués' },
                    ...
                    { key: 'lignesHTB', label: 'Lignes HTB' },
                    ...
                    { key: 'abf', label: 'ABF' },
                    { key: 'sdis', label: 'SDIS' },
                    { key: 'feuxForetOLD', label: 'Feux de forêt (OLD)' },
                    ...
                    { key: 'installationsProd', label: 'Installations Prod.' },
                    { key: 's3renr', label: 'S3REnR' },
                  ...
                  {isLayersOpen && (
                    <div className="p-2 bg-gray-50 flex flex-wrap gap-1.5">
                      {[
                        ...
                        { key: 'zonesHumides', label: 'Z. Humides' },
                        { key: 'argilesRGA', label: 'Argiles (RGA)' },
                        { key: 'sitesPollues', label: 'Sites Pollués' },
                        ...
                        { key: 'abf', label: 'ABF' },
                        { key: 'sdis', label: 'SDIS' },
                        { key: 'feuxForetOLD', label: 'Feux forêt (OLD)' },
                        ...
                        { key: 'installationsProd', label: 'Inst. Prod.' },
                        { key: 's3renr', label: 'S3REnR' },
                        { key: 'consoElecCommune', label: 'Conso. élec.' },
                        { key: 'dpe', label: 'DPE' },
