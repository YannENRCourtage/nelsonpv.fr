...
export function calculateSolarLayout(surfaceWidth, surfaceLength, forceFullCoverage = false, customGap = null, customMargin = null) {
    const effectiveGap = customGap !== null ? customGap : (forceFullCoverage ? 0 : GAP);
    const effectiveMargin = customMargin !== null ? customMargin : (forceFullCoverage ? 0 : MARGIN);
