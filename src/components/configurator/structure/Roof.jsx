        ...
        return (
            <group>
                ...
                <mesh geometry={section1Geo} material={roofMaterial}
                    position={[width / 2 - section1Props.x, asymRightEaveH + section1Props.y - 0.05, -length - 0.5]}
                ...
                <mesh geometry={section2Geo} material={roofMaterial}
                    position={[middleColumnX - section2Props.x, middleColumnHeight + section2Props.y - 0.05, -length - 0.5]}
                ...
                <mesh geometry={section3Geo} material={roofMaterial}
                    position={[-width / 2 + section3Props.x, asymLeftEaveH + section3Props.y - 0.40, -length - 0.5]}
