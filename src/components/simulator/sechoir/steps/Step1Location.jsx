        ...
        <AnimatePresence>
          {showDropdown && results.length > 0 && (
            <motion.ul
              ...
              className="absolute z-[9999] left-0 right-0 top-full mt-2 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden max-h-64 overflow-y-auto divide-y divide-slate-800"
            >
              {results.map((feature) => (
                <li
