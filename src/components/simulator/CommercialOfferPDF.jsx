          ...
          <div style="display: grid; grid-template-columns: 1fr 1.25fr; gap: 8px; margin-bottom: 10px; height: 310px;">
            ...
            <div style="border: 2px solid #cbd5e1; border-radius: 10px; overflow: hidden; background: #f8fafc; padding: 8px 10px; display: flex; flex-direction: column; justify-content: space-between; font-size: 7pt;">
              ...
              <table style="width: 100%; border-collapse: collapse; font-size: 6.8pt;">
                <tr style="border-bottom: 1px solid #e2e8f0;"><td style="padding: 1.5px 0; color: #64748b;">Investissement Brut Séchoir :</td><td style="text-align: right; font-weight: bold;">${(sim.totalInvestmentHT || 327053).toLocaleString('fr-FR')} € HT</td></tr>
                ...
                <tr style="border-bottom: 1px solid #cbd5e1; background: #fffbeb;"><td style="padding: 2px 0; font-weight: bold; color: #b45309;">Investissement Net à Financer :</td><td style="text-align: right; font-weight: 900; color: #b45309;">${(sim.investissementNet !== undefined ? sim.investissementNet : (sim.totalInvestmentHT ? Math.max(0, sim.totalInvestmentHT - (sim.primeCEE || 0)) : 288263)).toLocaleString('fr-FR')} € HT</td></tr>
                ${sim.subventionRegionaleMontant ? `
                  <tr style="border-bottom: 1px solid #e2e8f0; font-size: 6.2pt; color: #64748b;"><td style="padding: 1.5px 0;"><em>Aide régionale potentielle (${sim.subventionRegionaleNom || 'PCAE'}) :</em></td><td style="text-align: right; color: #d97706; font-weight: 600;"><em>jusqu'à ${sim.subventionRegionaleMontant.toLocaleString('fr-FR')} € (indicatif)</em></td></tr>
                ` : ''}
                <tr style="border-bottom: 1px solid #e2e8f0;"><td style="padding: 1.5px 0; color: #64748b;">Montant de l'emprunt (25 ans) :</td><td style="text-align: right; font-weight: bold;">${(sim.emprunt !== undefined ? sim.emprunt : (sim.investissementNet || 288263)).toLocaleString('fr-FR')} €</td></tr>
                <tr style="border-bottom: 1px solid #e2e8f0;"><td style="padding: 1.5px 0; color: #dc2626;">Montant moyen de l'annuité :</td><td style="text-align: right; font-weight: bold; color: #dc2626;">-${(sim.annuite || 17386).toLocaleString('fr-FR')} €/an</td></tr>
