...
const useNotifications = () => {
    ...
    useEffect(() => {
        try {
            const stored = safeLocalStorage.getItem(LS_NOTIFICATIONS_KEY);
    ...
    const addNotification = useCallback((notification) => {
        setNotifications(prev => {
            ...
            try {
                safeLocalStorage.setItem(LS_NOTIFICATIONS_KEY, JSON.stringify(newNotifications));
            } catch (error) {
    ...
    const markAllAsRead = useCallback(() => {
        setNotifications(prev => {
            ...
            try {
                safeLocalStorage.setItem(LS_NOTIFICATIONS_KEY, JSON.stringify(updated));
            } catch (error) {
