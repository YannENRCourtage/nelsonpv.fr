...
export const DRYING_MATERIALS = [
  {
    ...
    defaultVolume: 0,
    description: 'Foin en vrac séché sous panneaux thermovoltaïques',
  },
  {
    id: 'bottes_carrees',
    label: 'Bottes carrées',
    icon: '📦',
    unit: 't MS/an',
    defaultPlusValueQualite: 30,
    defaultEconomieEnergie: 20,
    defaultVolume: 0,
    description: 'Bottes de foin rectangulaires haute densité',
  },
  {
    id: 'cereales',
    label: 'Céréales',
    ...
    defaultVolume: 0,
    description: 'Séchage de céréales (blé, orge, maïs…)',
  },
  {
    id: 'plaquettes',
    label: 'Plaquettes de bois',
    icon: '🪵',
    unit: 't MS/an',
    defaultPlusValueQualite: 8,
    defaultEconomieEnergie: 18,
    defaultVolume: 0,
    description: 'Plaquettes forestières pour chaufferie bois',
  },
];
