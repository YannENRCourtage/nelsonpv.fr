...
// 'project' et 'setProject' viennent maintenant du Contexte via MapEditor,
// mais je les garde ici car votre AppLayout les utilise pour le PDF.
// Nous allons utiliser le contexte pour la mise à jour.
...
export default function ProjectMap({ onGpsUpdate }) {
  ...
  const requestCapture = (slotIndex) => {
    // Le nom de l'événement est "map:capture-request"
  ...
  return (
    <div className="w-full">
      {/* MODIFICATION DE LA GRILLE :
        - col-span-9  -> col-span-10 (plus large)
        - col-span-3  -> col-span-2 (plus étroit)
      */}
        ...
        <div className="col-span-10"> {/* Modifié */}
          <div className="rounded-2xl bg-white shadow-sm overflow-hidden">
            <MapEditor
              ...
              // onCapture n'existe pas sur MapEditor, la comm se fait par événements
              className="w-full"
